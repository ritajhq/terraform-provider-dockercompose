...
// DevelopConfig represents the develop section of a service (Compose Watch).
type DevelopConfig struct {
	Watch []WatchConfig `yaml:"watch,omitempty"`
}

// WatchConfig represents a single develop.watch entry.
type WatchConfig struct {
	Path   string     `yaml:"path,omitempty"`
	Action string     `yaml:"action,omitempty"`
	Target string     `yaml:"target,omitempty"`
	Ignore []string   `yaml:"ignore,omitempty"`
	Exec   *WatchExec `yaml:"exec,omitempty"`
}

// WatchExec represents the exec block for a sync+exec watch action.
